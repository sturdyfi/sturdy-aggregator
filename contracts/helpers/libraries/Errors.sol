...
library Errors {
  ...
  string internal constant AG_CALLER_NOT_ADMIN = '127';
  string internal constant AG_CALLER_NOT_AGGREGATOR = '128';
  string internal constant AG_ALREADY_INITIALIZED = '129';
  string internal constant AG_INVALID_CONFIGURATION = '130';
